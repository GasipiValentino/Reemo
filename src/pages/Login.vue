    ...
    async handleSubmit() {
      ...
      try {
        ...
        if(errorCode === 'auth/invalid-credential'){
          this.errorMsg = 'Credenciales inválidas. Por favor, revisa tu correo y contraseña.';
        }
...
<template>
  ...
  <form 
   ...
   <router-link to="/Register" class="transition-all py-2 px-4 rounded bg-yellow-700 text-white focus:bg-blue-500 hover:bg-blue-500 active:bg-blue-900">Crear Cuenta</router-link>
  </form>
</template>