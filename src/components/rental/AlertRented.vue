...
<template>
    ...
    <button type="button" data-dropdown-toggle="notification-dropdown" class="p-2 mr-1 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 mr-10">
        ...
        <div v-for="request in pendingRequests" :key="request.id" class="border p-4 mb-4">
            ...
            <div class="ms-3 text-sm font-normal">
                ...
                <div class="mb-2 text-sm font-normal">
                    <span class="mb-1 text-sm font-semibold text-blue-900">{{ request.name }}</span> quiere alquilar tu auto! Responde cuanto antes.
                </div>
